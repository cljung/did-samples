...
namespace VerifiedIDServiceBus
{
    ...
    public class IssuerController : ControllerBase
    {
        ...
        public async Task<ActionResult> IssuanceRequest()
        {
            ...
            try
            {
                ...
                try
                {
                    ...
                    SetClaims( request );
                    request.callback.url = $"{_configuration["VerifiedID:SbCallbackURL"]}?type=Issuance&queue={_configuration["VerifiedID:SbQueueName"]}";
        ...
        public ActionResult SelfieRequest() {
            ...
            try {
                ...
                var request = new {
                    id = id,
                    url = $"{hostname}/api/issuer/selfie/{id}",
