...
namespace VerifiedIDEAM.Helpers {
    public class KeyVaultHelper {
        ...
        private static string Base64Pad( string arg ) {
        ...
        // JWT decode helpers
        private static JObject GetJwtPart( string jwtToken, int part ) {
            return JObject.Parse( GetJwtPartAsString( jwtToken, part ) );
        }
        private static string GetJwtPartAsString( string jwtToken, int part ) {
            if (!(part == 0 || part == 1))
